...
(function () {
  ...
  var closeMenuLinkProgram = document.querySelector('.js-close-menu-link-program');
  var closeMenuLinkAbout = document.querySelector('.js-close-menu-link-about');
  var closeMenuLinkTraining = document.querySelector('.js-close-menu-link-training');
  var closeMenuLinkContacts = document.querySelector('.js-close-menu-link-contacts');
  var menuBtnRef = document.querySelector("[data-menu-button]");
  var consultationButton = document.querySelector('.consultation-button__mob-menu');

  var toggleMenu = function toggleMenu() {
    var isMenuOpen = menuBtnRef.getAttribute("aria-expanded") === "true" || false;
  ...
  consultationButton.addEventListener('click', toggleMenu); // Закрываем мобильное меню на более широких экранах
